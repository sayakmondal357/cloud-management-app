    ...
    return (
        <div className='w-screen h-[80px] z-10 bg-zinc-200 fixed drop-shadow-lg'>
            <div className='px-2 flex justify-between items-center w-full h-full'>
                <div className='flex items-center'>
                    ...
                    <ul className='hidden md:flex hover:cursor-pointer'>
                        ...
                        <li><Link to="links" smooth={true} offset={-100} duration={500}>Links</Link></li>
                    </ul>
                </div>
            ...
            <ul className={!nav ? 'hidden' : 'absolute bg-zinc-200 w-full px-8'}>
                ...
                <li className='border-b-2 border-zinc-300 w-full'><Link onClick={handleClose} to="links" smooth={true} offset={-100} duration={500}>Links</Link></li>
